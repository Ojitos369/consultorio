...
INSERT INTO `seccion` (id_encuesta, nombre, descripcion, clase) VALUES (1,'personales','datos personales', 'seccion-1'),(1,'direccion','datos de la direccion','seccion-2'),(1,'contacto','datos de contacto','seccion-3'),(1,'medico','datos medicos','seccion-4'),(1,'enterado','dato de enterarse','seccion-5'),(2,'satisfaccion','preguntas de satisfacion','seccion-6');
UNLOCK TABLES;

LOCK TABLES `preguntas` WRITE;
INSERT INTO `preguntas` (id_seccion, pregunta, tipo, clase) VALUES (1,'NOMBRE Y APELLIDO','text','pregunta-1'),(1,'FECHA DE NACIMIENTO','date','pregunta-2'),(1,'ESTADO CIVIL','radio','pregunta-3'),(2,'País','text','pregunta-4'),(2,'Ciudad','text','pregunta-5'),(2,'Código Postal','number','pregunta-6'),(2,'Calle','text','pregunta-7'),(2,'Número interior y/o exterior','text','pregunta-8'),(3,'DIRECCIÓN','array','pregunta-9'),(3,'TELÉFONO','number','pregunta-10'),(3,'CORREO ELECTRÓNICO','email','pregunta-11'),(4,'TIPO DE CIRUGÍA REALIZADA','text','pregunta-12'),(4,'CIRUGÍAS PREVIAS (SI NO) Y CUANTAS','number','pregunta-13'),(4,'FECHA DE CIRUGÍA','date','pregunta-14'),(4,'PROTOCOLO POSTQUIRÚRGICO','radio','pregunta-15'),(5,'¿CÓMO TE ENTERASTE DE PLASTIC SURGERY RECOVERY?','text','pregunta-16'),(6,'¿Cómo calificarías el servicio brindado por la dermotherapist Lorena Gómez?','radio','pregunta-17'),(6,'¿Cómo calificarías el servicio dentro de Plastic Surgery Recovery?','radio','pregunta-18'),(6,'¿Qué te gustaría que implementemos o mejoremos?','text','pregunta-19');
UNLOCK TABLES;
