...
INSERT INTO `preguntas` (id_seccion, pregunta, tipo, clase) VALUES (1,'NOMBRE Y APELLIDO','text','pregunta-1'),(1,'FECHA DE NACIMIENTO','date','pregunta-2'),(1,'ESTADO CIVIL','radio','pregunta-3'),(2,'País','text','direccion pregunta-4'),(2,'Ciudad','text','direccion pregunta-5'),(2,'Código Postal','number','direccion pregunta-6'),(2,'Calle','text','direccion pregunta-7'),(2,'Número interior y/o exterior','text','direccion pregunta-8'),(3,'TELÉFONO','number','pregunta-10'),(3,'CORREO ELECTRÓNICO','email','pregunta-11'),(4,'TIPO DE CIRUGÍA REALIZADA','text','pregunta-12'),(4,'CIRUGÍAS PREVIAS (SI NO) Y CUANTAS','number','pregunta-13'),(4,'FECHA DE CIRUGÍA','date','pregunta-14'),(4,'PROTOCOLO POSTQUIRÚRGICO','radio','pregunta-15'),(5,'¿CÓMO TE ENTERASTE DE PLASTIC SURGERY RECOVERY?','text','opinion pregunta-16'), (6,'NOMBRE','text','pregunta-17'), (7,'¿Cómo calificarías el servicio brindado por la dermotherapist Lorena Gómez?','radio','pregunta-18'),(7,'¿Cómo calificarías el servicio dentro de Plastic Surgery Recovery?','radio','pregunta-19'),(7,'¿Qué te gustaría que implementemos o mejoremos?','text','opinion pregunta-20');
UNLOCK TABLES;
