...
INSERT INTO `preguntas` (id_seccion, pregunta, tipo, clase) VALUES (1,'Nombre y apellido','text','pregunta-1'),(1,'Fecha de nacimiento','date','pregunta-2'),(1,'Estado civil','radio','pregunta-3'),(2,'País','text','direccion pregunta-4'),(2,'Ciudad','text','direccion pregunta-5'),(2,'Código Postal','number','direccion pregunta-6'),(2,'Calle','text','direccion pregunta-7'),(2,'Número interior y/o exterior','text','direccion pregunta-8'),(3,'Teléfono','number','pregunta-10'),(3,'Correo electrónico','email','pregunta-11'),(4,'Tipo de cirugía realizada','text','pregunta-12'),(4,'Cirugías previas (si/no(0)): cuantas','number','pregunta-13'),(4,'Fecha de cirugía','date','pregunta-14'),(4,'Protocolo postquirúrgico','radio','pregunta-15'),(5,'¿Cómo te enteraste de Plastic Surgery Recovery?','text','opinion pregunta-16'), (6,'Nombre','text','pregunta-17'), (7,'¿Cómo calificarías el servicio brindado por la dermotherapist Lorena Gómez?','radio','pregunta-18'),(7,'¿Cómo calificarías el servicio dentro de Plastic Surgery Recovery?','radio','pregunta-19'),(7,'¿Qué te gustaría que implementemos o mejoremos?','text','opinion pregunta-20');
UNLOCK TABLES;
